...
<link>{ITEM_LINK}</link>
<description>{ITEM_DESCRIPTION}</description> <author>{ITEM_AUTHOR}</author>
<!-- BEGIN item_category --><category>{CATEGORY}</category><!-- END item_category -->
<comments>{ITEM_COMMENTS}</comments> <enclosure>{ITEM_ENCLOSURE}</enclosure>
<pubDate>{ITEM_PUBDATE}</pubDate> <guid isPermaLink="true">{ITEM_GUID}</guid>
